...
public class World : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        spawnPosition = new Vector3((VoxelData.WorldSizeInChunks * VoxelData.ChunkWidth) / 2f, VoxelData.ChunkHeigth + - 50f, (VoxelData.WorldSizeInChunks * VoxelData.ChunkWidth) / 2f);
        GenerateWorld();
    ...
    private void Update()
    {
        ...
        // Only update th chunks if the player has moves from the chunk they were previously on
    ...
    public byte GetVoxel(Vector3 pos)
    {
        ...
        int terrainHeight = Mathf.FloorToInt(biome.terrainHeight * Noise.Get2DPerlin(new Vector2(pos.x, pos.z), 0, biome.terrianScale)) + biome.solidGroundHeight;
        byte voxelValue = 0;
