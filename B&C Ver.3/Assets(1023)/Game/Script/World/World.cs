...
public class World : MonoBehaviour
{
    ...
    public bool hasSpawnBox;
    public bool hasClearBox;
    ...
    public GameObject buildPanel;                                                           // 빌드 모드 패널
    public GameObject clearPanel;                                                           // 클리어 모드 패널
    ...
    private void Start()
    {
        ...
        if(isBuildMode)
        {
            ...
            buildPlayer.GetComponent<CharacterController>().enabled = false;
            buildPlayer.transform.SetPositionAndRotation(new Vector3(-5, 5, -5), Quaternion.Euler(0, 45, 0));
            buildPlayer.GetComponent<CharacterController>().enabled = true;
        ...
        else
        {
            ...
            clearPlayer.GetComponent<CharacterController>().enabled = false;
            clearPlayer.transform.SetPositionAndRotation(new Vector3(settings.cpX + 0.5f, settings.cpY + 1.5f, settings.cpZ + 0.5f), Quaternion.Euler(0, 45, 0));
            clearPlayer.GetComponent<CharacterController>().enabled = true;
    ...
    public void SetGlobalLightValue()
    {
        ...
        {
            Shader.SetGlobalFloat("GlobalLightLevel", 0.5f);
...
public class BlockType
{
    ...
    // 블록타입 >> 0 = 공기, 1 = 기본, 2 = 플레이어 상호작용, 3 = 성, 4 = 도시, 5 = 숲, 6 = 얼음, 7 = 장난감
}
...
{
    public string mapName = "";                                                             // 맵 이름
    public bool isCanBeCleared;                                                             // 클리어모드 진입 가능 맵 여부

    public int cpX, cpY, cpZ;                                                               // 클리어모드 플레이어의 스폰좌표
