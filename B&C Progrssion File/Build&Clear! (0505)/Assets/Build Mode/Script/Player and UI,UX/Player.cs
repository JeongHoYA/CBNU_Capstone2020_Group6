...
public class Player : MonoBehaviour
{
    ...
    {
        if (
            world.CheckForVoxelisSolid(new Vector3(transform.position.x, transform.position.y + downSpeed, transform.position.z))
           )
        {
            isGrounded = true;
    ...
    private float checkUpSpeed(float upSpeed)
    {
        ...
        if (
            world.CheckForVoxelisSolid(new Vector3(transform.position.x, transform.position.y + 1.8f + upSpeed, transform.position.z))
           )
            return 0;
        else
            return upSpeed;
    ...
    public bool front
    {
        ...
        {
            if (
                world.CheckForVoxelisSolid(new Vector3(transform.position.x, transform.position.y + 0.6f, transform.position.z + playerWidth)) ||
                world.CheckForVoxelisSolid(new Vector3(transform.position.x, transform.position.y + 1.2f, transform.position.z + playerWidth))
                )
                return true;
            else
                return false;
    ...
    public bool left
    {
        ...
        {
            if (
                world.CheckForVoxelisSolid(new Vector3(transform.position.x - playerWidth, transform.position.y + 0.6f, transform.position.z)) ||
                world.CheckForVoxelisSolid(new Vector3(transform.position.x - playerWidth, transform.position.y + 1.2f, transform.position.z))
                )
                return true;
            else
                return false;
