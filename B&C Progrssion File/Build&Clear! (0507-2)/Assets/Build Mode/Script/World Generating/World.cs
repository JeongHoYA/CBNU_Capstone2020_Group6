...
{
    [Range(0.7f, 0f)]
    public float globalLightLevel;                                      // 월드 내 복셀의 어두움 정도
    public Color day;                                                   // 낮의 하늘 색깔
    public Color night;                                                 // 밤의 하늘 색깔
    ...
    private void Start()
    {
        ...
        spawnPosition = new Vector3(5, 23, 5);
    ...
    public void SetGlobalLightValue()
    {
        ...
        Camera.main.backgroundColor = Color.Lerp(day, night, (globalLightLevel * 1.4f));
    }                               // 월드의 라이트를 설정하는 함수
    ...
    void GenerateWorld()
    {
        ...
        {
            for (int z = 0; z < settings.viewDistance; z++)
            {
