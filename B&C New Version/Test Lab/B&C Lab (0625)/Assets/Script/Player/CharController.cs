...
public class CharController : MonoBehaviour
{
    ...
    public PlayerStat playerStat;                                                           // 플레이어 스탯 스크립트
    ...
    public bool jump;                                                                       // 플레이어의 점프 입력 여부
    public bool attack;                                                                     // 플레이어 공격 여부
    public bool dash;                                                                       // 플레이어 대쉬 여부

    //public bool isSlowed;                                                                   // 플레이어 느려짐 여부
    //public bool isDotDamaged;                                                               // 플레이어 도트 데미지 여부
    ...
    private void FixedUpdate()
    {
        ...
        if (transform.position.y < -3f && playerStat.isDead == false && playerStat.LevelClear == false)
        {
    ...
    private void PlayerMove()
    {
        ...
        if(u != 0 || r != 0) {
            ...
            controller.Move(heading * playerStat.moveSpeed * Time.deltaTime);
        }
        ...
        if(jump && isGrounded()) {
            up.y = Jump(playerStat.jumpHeight);
        }
    ...
    {
        return Mathf.Sqrt(height * -4f * gravity);
    }                      // 플레이어 점프 함수
