...
public class World : MonoBehaviour
{
    ...
    public Color day;                                                                       // 낮 하늘 색깔
    public Color night;                                                                     // 밤 하늘 색깔
    ...
    private void Start()
    {
        ...
        //File.WriteAllText(Application.dataPath + "/" + settings.mapName + " settings.cfg", jsonExport);

        string jsonImport = File.ReadAllText(Application.dataPath + "/" + settings.mapName + " settings.cfg");
        settings = JsonUtility.FromJson<Settings>(jsonImport);


        SetGlobalLightValue();

        spawnPosition = new Vector3(5, 50, 5);
    ...
    {
        Shader.SetGlobalFloat("GlobalLightLevel", settings.globalLightLevel);
        Camera.main.backgroundColor = Color.Lerp(day, night, settings.globalLightLevel * 1.4f);
    }
...
public class Settings
{
    ...
    [Range(2, 4)]
    public int viewDistance;                                                                // 가시거리

    [Range(0, 0.7f)]
    public float globalLightLevel;                                                          // 맵 밝기
