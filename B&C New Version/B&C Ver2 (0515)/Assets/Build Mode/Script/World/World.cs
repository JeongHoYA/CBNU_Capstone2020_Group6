...
public class World : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        File.WriteAllText(Application.dataPath + "/Build Mode" + "/" + settings.mapName + " settings.cfg", jsonExport);
    ...
    public void SetGlobalLightValue()
    {
        if(settings.isDay)
        {
            ...
            Camera.main.backgroundColor = Color.Lerp(day, night, 0);
        }
        else
        {
            Shader.SetGlobalFloat("GlobalLightLevel", 0.7f);
            Camera.main.backgroundColor = Color.Lerp(day, night, 1f);
        } 
    }
